...
def evaluate_models(home_stack, away_stack, x_test: pd.DataFrame, y_reg_test_home: pd.Series, y_reg_test_away: pd.Series, rho: float) -> None:
    """Evalua la precision de los modelos en el conjunto de prueba."""
...
def main() -> None:
    ...
    parser = argparse.ArgumentParser(description="WhereItLands - Prediccion de Futbol")
    parser.add_argument("--mode", type=str, default="train", choices=["train"], help="Modo de ejecucion.")
    parser.add_argument("--skip-training", action="store_true", help="Guarda unicamente los artefactos de datos y ELO sin entrenar modelos.")
    ...
    if args.mode == "train":
        print("Iniciando procesamiento de datos y calculo de ELO...")
        ...
        if args.skip_training:
            print("Opcion --skip-training activada. Artefactos de ELO e historial guardados exitosamente.")
            return
